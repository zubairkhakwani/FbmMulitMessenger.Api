      ...
      (() => {
        ...
        class g {
          ...
          static get isWebWorker() {
            return (
              !g.isNode && "object" == typeof self && "importScripts" in self
            );
          }
        ...
        class T extends d {
          constructor(e) {
            if (
              (super(), (this.u = e), "undefined" == typeof fetch || g.isNode)
            ) {
              const t = require;
          ...
          async send(t) {
            ...
            try {
              h = await this.m(t.url, {
                ...
                cache: "no-cache",
                credentials:
                  !0 === t.withCredentials ? "include" : "same-origin",
              ...
              if (o) throw o;
              throw (
                (this.u.log(e.Warning, `Error from HTTP request. ${t}.`), t)
              );
            } finally {
              c && clearTimeout(c),
        ...
        class L {
          ...
          async B() {
            ...
            await this.R.send(
              this.D.writeMessage({ type: x.Sequence, sequenceId: t })
            );
            const e = this.S;
          ...
          O() {
            void 0 === this.V &&
              (this.V = setTimeout(async () => {
                try {
                  this.H ||
                    (await this.R.send(
                      this.D.writeMessage({ type: x.Ack, sequenceId: this.I })
                    ));
                } catch {}
        ...
        class q {
          ...
          constructor(t, s, i, n, r, o, h) {
            (this.K = 0),
              ...
              (this.dt = !1),
              (this.ft = this.D.writeMessage({ type: x.Ping }));
          }
          get state() {
            return this.ut;
          }
          ...
          async gt() {
            ...
            try {
              await this.yt(),
                g.isBrowser &&
                  window.document.addEventListener("freeze", this.G),
                (this.ut = A.Connected),
                (this.dt = !0),
          ...
          async yt() {
            ...
            try {
              ...
              !!this.connection.features.reconnect &&
                ((this.Pt = new L(this.D, this.connection, this.Y)),
                (this.connection.features.disconnected = this.Pt.L.bind(
                  this.Pt
                )),
          ...
          off(t, e) {
            ...
            if (s)
              if (e) {
                const i = s.indexOf(e);
                -1 !== i &&
                  (s.splice(i, 1), 0 === s.length && delete this.nt[t]);
                  ...
                  switch (t.type) {
                    case x.Invocation:
                      this.Wt(t).catch((t) => {
                        this.u.log(
                          e.Error,
                          `Invoke client method threw error: ${P(t)}`
                        );
                      });
                      break;
                    case x.StreamItem:
                    ...
                    case x.Close: {
                      ...
                      const s = t.error
                        ? new Error(
                            "Server returned an error on close: " + t.error
                          )
                        : void 0;
                      !0 === t.allowReconnect
          ...
          jt(t) {
            ...
            return (
              this.u.log(e.Debug, "Server handshake complete."), this.vt(), i
            );
          }
          kt() {
            this.connection.features.inherentKeepAlive ||
          ...
          async Wt(t) {
            ...
            c
              ...
              : r
              ? (h
                  ? (c = this.Bt(t.invocationId, `${h}`, null))
                  : void 0 !== o
                  ? (c = this.Bt(t.invocationId, null, o))
                  : (this.u.log(
                      e.Warning,
                      `No result given for '${s}' method and invocation ID '${t.invocationId}'.`
                    ),
          ...
          st(t) {
            this.u.log(
              e.Debug,
              `HubConnection.connectionClosed(${t}) called while in state ${this.ut}.`
            ),
              (this.bt =
                this.bt ||
                t ||
              ...
              this.ut === A.Disconnecting
                ? this.Dt(t)
                : this.ut === A.Connected && this.Z
                ? this.Jt(t)
                : this.ut === A.Connected && this.Dt(t);
          }
          Dt(t) {
            if (this.dt) {
              (this.ut = A.Disconnected),
                (this.dt = !1),
                this.Pt &&
                  (this.Pt.X(null != t ? t : new Error("Connection closed.")),
                  (this.Pt = void 0)),
                g.isBrowser &&
                  window.document.removeEventListener("freeze", this.G);
              try {
              ...
              try {
                ...
                if (
                  ...
                  return (
                    this.u.log(
                      e.Debug,
                      `Connection moved to the '${this.ut}' from the reconnecting state during reconnect attempt. Done reconnecting.`
                    ),
          ...
          Mt(t, e, s, i) {
            if (s)
              return 0 !== i.length
                ? { target: t, arguments: e, streamIds: i, type: x.Invocation }
                : { target: t, arguments: e, type: x.Invocation };
            {
              const s = this.ct;
              return (
                this.ct++,
          ...
          Bt(t, e, s) {
            return e
              ? { error: e, invocationId: t, type: x.Completion }
              : { invocationId: t, result: s, type: x.Completion };
          }
          At() {
            return { type: x.Close };
          }
        ...
        class O extends d {
          ...
          async send(t) {
            let e = !0;
            this.Yt &&
              (!this.Zt || (t.url && t.url.indexOf("/negotiate?") > 0)) &&
              ((e = !1), (this.Zt = await this.Yt())),
              this.te(t);
            const s = await this.Qt.send(t);
            return e && 401 === s.statusCode && this.Yt
              ? ((this.Zt = await this.Yt()), this.te(t), await this.Qt.send(t))
              : s;
          }
          te(t) {
            t.headers || (t.headers = {}),
              this.Zt
                ? (t.headers[W.Authorization] = `Bearer ${this.Zt}`)
                : this.Yt &&
                  t.headers[W.Authorization] &&
                  delete t.headers[W.Authorization];
          }
          getCookieString(t) {
        ...
        class J {
          ...
          async send(t) {
            return this.ne
              ? b(this.u, "LongPolling", this.$, this.re, t, this.ie)
              : Promise.reject(
          ...
          async stop() {
            ...
            try {
              await this.he,
                this.u.log(
                  e.Trace,
                  `(LongPolling transport) sending DELETE request to ${this.re}.`
                );
              const t = {},
                [s, n] = $();
              t[s] = n;
              ...
              o
                ? o instanceof i &&
                  (404 === o.statusCode
                    ...
                    : this.u.log(
                        e.Trace,
                        `(LongPolling transport) Error sending a DELETE request: ${o}`
                      ))
                : this.u.log(
                    e.Trace,
        ...
        class z {
          ...
          async connect(t, s) {
            return (
              ...
              this.Zt &&
                (t +=
                  (t.indexOf("?") < 0 ? "?" : "&") +
                  `access_token=${encodeURIComponent(this.Zt)}`),
              new Promise((i, n) => {
                let r,
                  o = !1;
                if (s === B.Text) {
          ...
          async send(t) {
            return this.ue
              ? b(this.u, "SSE", this.$, this.re, t, this.ie)
              : Promise.reject(
                  new Error("Cannot send until the transport is connected")
                );
          }
        ...
        class V {
          ...
          send(t) {
            return this.we && this.we.readyState === this.fe.OPEN
              ? (this.u.log(
                  e.Trace,
                  `(WebSockets transport) sending data. ${m(t, this.de)}.`
                ),
                this.we.send(t),
                Promise.resolve())
          ...
          le(t) {
            this.we &&
              ...
              this.onclose &&
                (!this.ge(t) || (!1 !== t.wasClean && 1e3 === t.code)
                  ? t instanceof Error
                    ? this.onclose(t)
                    : this.onclose()
                  : this.onclose(
        ...
        class K {
          ...
          async start(t) {
            if (
              ...
              this.u.log(
                e.Debug,
                `Starting connection with transfer format '${B[t]}'.`
              ),
            ...
            if (
              ...
              return (
                this.u.log(e.Error, t), await this.It, Promise.reject(new r(t))
              );
            }
          ...
          send(t) {
            return "Connected" !== this.ut
              ? Promise.reject(
                  new Error(
                    "Cannot send data if the connection is not in the 'Connected' State."
                  )
                )
              : (this.Ee || (this.Ee = new G(this.transport)), this.Ee.send(t));
          }
          async stop(t) {
            return "Disconnected" === this.ut
              ? (this.u.log(
                  e.Debug,
          ...
          async Pe(t) {
            ...
            try {
              ...
              return (
                ...
                e.useStatefulReconnect && !0 !== this.ie._e
                  ? Promise.reject(
                      new a(
          ...
          async Te(t, s, i, n) {
            ...
            for (const i of a) {
              const a = this.Re(
                ...
                s,
                n,
                !0 === (null == u ? void 0 : u.useStatefulReconnect)
              );
              if (a instanceof Error)
                ...
                try {
                  ...
                  if (
                    ...
                    (u = void 0),
                    h.push(
                      new c(`${i.transport} failed: ${t}`, F[i.transport])
                    ),
                    "Connecting" !== this.ut)
                  ) {
                    const t =
          ...
          ke(t, e) {
            return (
              ...
              this.features.reconnect
                ? (this.transport.onclose = async (s) => {
                    let i = !1;
          ...
          Re(t, s, i, n) {
            ...
            if (
              ...
              return (
                this.u.log(
                  e.Debug,
                  `Skipping transport '${F[r]}' because it was disabled by the client.`
                ),
            ...
            if (!(t.transferFormats.map((t) => B[t]).indexOf(i) >= 0))
              return (
                this.u.log(
                  e.Debug,
                  `Skipping transport '${F[r]}' because it does not support the requested transfer format '${B[i]}'.`
                ),
                new Error(`'${F[r]}' does not support ${B[i]}.`)
              );
            if (
              (r === F.WebSockets && !this.ie.WebSocket) ||
              (r === F.ServerSentEvents && !this.ie.EventSource)
            )
              return (
                this.u.log(
                  e.Debug,
                  `Skipping transport '${F[r]}' because it is not supported in your environment.'`
                ),
            ...
            try {
              return (
                (this.features.reconnect = r === F.WebSockets ? n : void 0),
                this.Se(r)
              );
            } catch (t) {
              return t;
          ...
          Ce(t) {
            if (
              (this.u.log(
                e.Debug,
                `HttpConnection.stopConnection(${t}) called while in state ${this.ut}.`
              ),
              (this.transport = void 0),
              (t = this.$e || t),
              (this.$e = void 0),
          ...
          Ie(t) {
            const e = new URL(t);
            e.pathname.endsWith("/")
              ? (e.pathname += "negotiate")
              : (e.pathname += "/negotiate");
            const s = new URLSearchParams(e.searchParams);
            return (
              s.has("negotiateVersion") ||
                s.append("negotiateVersion", this.ye.toString()),
              s.has("useStatefulReconnect")
                ? "true" === s.get("useStatefulReconnect") && (this.ie._e = !0)
                : !0 === this.ie._e && s.append("useStatefulReconnect", "true"),
              (e.search = s.toString()),
              e.toString()
            );
          }
        ...
        class Y {
          ...
          Be(t) {
            ...
            !t.result &&
              t.error &&
              this.ze(t.error, "Invalid payload for Completion message."),
              this.ze(
                t.invocationId,
        ...
        class tt {
          ...
          withAutomaticReconnect(t) {
            ...
            return (
              t
                ? Array.isArray(t)
                  ? (this.reconnectPolicy = new j(t))
                  : (this.reconnectPolicy = t)
                : (this.reconnectPolicy = new j()),
              this
            );
          }
          withServerTimeout(t) {
